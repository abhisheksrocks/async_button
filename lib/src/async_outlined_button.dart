...
class AsyncOutlinedButton extends AsyncButtonCore {
  ...
  factory AsyncOutlinedButton.withDefaultStyles({
    Key? key,
  ...
  @override
  State<AsyncButtonCore> createState() => _AsyncOutlinedButtonState();
}

class _AsyncOutlinedButtonState extends AsyncButtonCoreState {
